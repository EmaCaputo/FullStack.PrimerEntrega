...
app.use('/auth',auth); //Uso el middleware de autenticación para proteger las rutas, cualquier ruta que no tenga un token válido no podrá acceder a los recursos protegidos.    
